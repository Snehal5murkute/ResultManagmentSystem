...
class StudentClass:
    def __init__(self, root):
        ...
        lbl_Nmae = Label(self.root, text="Name", font=("goudy old style", 15, "bold"), bg="white")
        lbl_Nmae.place(x=10, y=100)
